...
begin {
    ...
    Write-BoltHeader -Solution $Solution -Dotsource:$Dotsource
    write-host "version: $($BuildId.ToString())"
    ...
    function Get-BoltScriptFile {
        ...
        $scripts = Get-ChildItem "$PSScriptRoot/code" -Recurse -Filter "*.ps1" -File
